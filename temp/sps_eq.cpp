...
// Serialization methods are not implemented in libff for these types.
template<typename ppT>
std::vector<uint8_t> PublicKey<ppT>::to_bytes() const {
    throw std::runtime_error("to_bytes not implemented");
}

template<typename ppT>
PublicKey<ppT> PublicKey<ppT>::from_bytes(const std::vector<uint8_t>& bytes) {
    throw std::runtime_error("from_bytes not implemented");
}

template<typename ppT>
std::vector<uint8_t> SigningKey<ppT>::to_bytes() const {
    throw std::runtime_error("to_bytes not implemented");
}

template<typename ppT>
SigningKey<ppT> SigningKey<ppT>::from_bytes(const std::vector<uint8_t>& bytes) {
    throw std::runtime_error("from_bytes not implemented");
}
